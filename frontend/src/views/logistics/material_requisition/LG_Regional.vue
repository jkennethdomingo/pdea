...
const regionData = computed(() => store.state.regionData);

onMounted(() => {
  store.dispatch('fetchregionData');
});
</script>
    ...
    <!-- component -->
        <div class="container m-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1 gap-y-6">
                <!-- profile cards -->
                <div class="flex flex-col" v-for="region in regionData">
                    <div class="bg-gray-300 dark:bg-gray-800 border border-gray-800 shadow-lg rounded-2xl max-w-sm p-4">
                        <div class="flex-none sm:flex">
                            <div class="relative h-32 w-36 sm:mb-0 mb-3">
                                <template v-if="region.region_name === null">
                                ...
                                <div class="flex items-center justify-between sm:mt-2">
                                    <div class="flex items-center">
                                        <div class="flex flex-col">
                                            ...
                                            <div class="text-xl dark:text-gray-200 text-gray-800 font-bold leading-none">{{ region.regional_office_name }}</div>
